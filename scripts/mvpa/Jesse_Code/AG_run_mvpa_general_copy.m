function [qqq, results]= AG_run_mvpa_general_copy(subj_array)
...
%for pP = 1:length(S.Ps);
    ...
    for b=1:length(subj_array)  % allows subject ID #'s to be specified in short format
        ...
        S.importance_maps_dir=[S.expt_dir '/mvpa_results/ImpMaps_022010/' [S.thisTrain S.thisTest] ];
        ...
        flags.mask = 12; %1 = 'merged_AAL_ROIs_FIXED_HOLES.nii'; 2 = subject-specific analysis mask. 3 = noLPFC jesse mask. 4 = AlanMaskNoLPFCNoMotor.img  5 = AlanMaskNoIPSNoLPFCNoMotor.img 
        ...
        elseif flags.mask==12
            S.roi_name = 'mask.img';
            S.roi_file = ['/Users/alangordon/Accumulator_fMRI/AG1/fmri_data2/group_analyses/Ret20Subs/PCor_Vs_SCor/' S.roi_name];
        end
        ...
        idealParams.nVox.respSel.Ret = 1000;
...
%                save(fullfile(S.mvpa_dir, 'abs_acts_diff_ret'), 'abs_acts_diff_ret');
                ...
                qqq.test{tT}.subj{b}.iter{n} = results{1};
