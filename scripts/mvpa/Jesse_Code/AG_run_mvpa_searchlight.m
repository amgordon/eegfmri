function [qqq, results]= AG_run_mvpa_searchlight(subj_array)
    ...
    for b=1:length(subj_array)  % allows subject ID #'s to be specified in short format
        ...
        for n = 1: flags.num_results_iter
            ...
            %             subj,'spiral_d_hp_z_condensed_srch', ...
                    ...
                    desireds_vector = [];
                    for nn = 1:S.num_runs
                        desireds_vector = [desireds_vector subj.regressors{1}.mat(1,subj.selectors{end}.mat==3)];
                    end
...
%                 sl_AUC_mean = mean(sl_AUC,2);
               ...
               vol_info = S.vol_info.vol_info;
                ...
                vol_info.fname = [S.searchlight_dir '/' subj_id '_' condnames{1} '_vs_' condnames{2} '_3vox_radius_top_100pct.nii'];
