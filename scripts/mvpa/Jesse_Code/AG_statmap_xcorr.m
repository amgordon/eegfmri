...
%pat(find(constant_rows),:)=[]; %commented out by AG 2/22/11
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [xcorr_p] = statmap_xcorr_logic(pat,regs,args)
...
t = xcorr.*sqrt((nRegs-2)./(1-xcorr.^2));
xcorr_p = 2*tcdf(-abs(t),nRegs-2);
