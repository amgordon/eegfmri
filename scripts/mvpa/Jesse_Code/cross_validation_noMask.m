function [subj results] = cross_validation_noMask(subj,patin,regsname,selgroup,maskgroup,class_args,varargin)
...
for n=1:nIterations
  ...
  masked_pats = get_mat(subj,'pattern',cur_patname);
  ...
  cur_iteration.created.maskname  = [];
