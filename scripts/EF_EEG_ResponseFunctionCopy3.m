...
%generate params
[S par idx] = EF_EEGResponseParamsCopy3(subj_id);
...
if S.loadEEGData
    ...
    for t = 1:length(S.TOI)
        ...
        for m=1:size(allPats,1)
            ...
            thisTrialSubset = (idx.TRsExist(:,m) & ~idx.nanpats & idx.new' & idx.respNew'); % which trials should be included in the classification?
